...
from lib import config, data_generators
from lib import losses as losses
import lib.roi_helpers as roi_helpers
from keras.utils import generic_utils
from lib.pascal_voc_parser import get_data
...
#       exit(1)
path='/home/ubuntu/safetipin/keras-frcnn/model.hdf5'
C.num_rois = int(options.num_rois)

if options.network == 'vgg':
        C.network = 'vgg'
        from lib import vgg as nn
elif options.network == 'resnet50':
        from lib import resnet as nn
        C.network = 'resnet50'
else:
                ...
                try:
                        if iter_num == 1000:
                                ...
                                if curr_loss < best_loss:
                                        ...
                                        best_loss = curr_loss
                                model_all.save_weights('model',overwrite=True,save_format='h5')
...
model_all.save("model_sep_27.h5")
